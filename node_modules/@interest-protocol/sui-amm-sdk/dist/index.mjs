...
var processPool = (data) => {
  if (!data)
    return DEFAULT_POOL;
  const poolType = pathOr("", ["data", "type"], data);
...
var SDK = class {
  ...
  async createStablePool({
    ...
    txb.moveCall({
      ...
      arguments: [
        ...
        txb.pure(coinAAmount),
        txb.pure(coinBAmount),
        txb.object(propOr2("", "id", coinAMetadata)),
        txb.object(propOr2("", "id", coinBMetadata))
      ]
    });
    return txb;
  }
  ...
  getSortedPoolCoins(coinAType, coinBType) {
    const poolType = pathOr2(null, [coinAType, coinBType], __privateGet(this, _POOLS));
