...
function toSerializedSignature({
  ...
  return (0, import_bcs4.toB64)(serializedSignature);
}
function fromSerializedSignature(serializedSignature) {
  const bytes = (0, import_bcs4.fromB64)(serializedSignature);
...
var Secp256k1PublicKey = class {
  ...
  toSuiAddress() {
    ...
    tmp.set(this.toBytes(), 1);
    return normalizeSuiAddress(
      (0, import_utils3.bytesToHex)((0, import_blake2b3.blake2b)(tmp, { dkLen: 32 })).slice(0, SUI_ADDRESS_LENGTH * 2)
    );
  }
  /**
   * Return the Sui address associated with this Secp256k1 public key
...
function mnemonicToSeedHex(mnemonics) {
  return (0, import_bcs7.toHEX)(mnemonicToSeed(mnemonics));
}
...
function fromExportedKeypair(keypair) {
  const secretKey = (0, import_bcs9.fromB64)(keypair.privateKey);
...
var getMasterKeyFromSeed = (seed) => {
  ...
  const I = h.update((0, import_bcs10.fromHEX)(seed)).digest();
...
var Ed25519Keypair = class {
  ...
  export() {
    return {
      schema: "ED25519",
      privateKey: (0, import_bcs11.toB64)(this.keypair.secretKey.slice(0, PRIVATE_KEY_SIZE))
    };
  }
};
...
var Secp256r1Keypair = class {
   ...
   */
  signData(data) {
    const msgHash = (0, import_sha2562.sha256)(data);
  ...
  export() {
    return {
      schema: "Secp256r1",
      privateKey: (0, import_bcs12.toB64)(this.keypair.secretKey)
    };
  }
};
...
function toMultiSigAddress(pks, threshold) {
  ...
  return normalizeSuiAddress(
    (0, import_utils6.bytesToHex)((0, import_blake2b6.blake2b)(tmp.slice(0, i), { dkLen: 32 }))
  );
}
...
function decodeMultiSig(signature) {
  const parsed = (0, import_bcs23.fromB64)(signature);
...
var TransferObjectsTransaction = (0, import_superstruct17.object)({
  ...
  address: PureTransactionArgument(import_bcs14.BCS.ADDRESS)
});
    ...
    return create(
      {
        kind: "Publish",
        modules: modules.map(
          (module2) => typeof module2 === "string" ? Array.from((0, import_bcs14.fromB64)(module2)) : module2
        ),
...
var builder = new import_bcs15.BCS(bcs);
...
builder.registerStructType(PROGRAMMABLE_TX_BLOCK, {
  ...
  GasCoin: null,
  Input: { index: import_bcs15.BCS.U16 },
  Result: { index: import_bcs15.BCS.U16 },
  NestedResult: { index: import_bcs15.BCS.U16, resultIndex: import_bcs15.BCS.U16 }
}).registerStructType(PROGRAMMABLE_CALL_INNER, {
  package: import_bcs15.BCS.ADDRESS,
  module: import_bcs15.BCS.STRING,
  function: import_bcs15.BCS.STRING,
   ...
   */
  Publish: {
    modules: [VECTOR2, [VECTOR2, import_bcs15.BCS.U8]],
    dependencies: [VECTOR2, import_bcs15.BCS.ADDRESS]
  },
  /**
  ...
  Upgrade: {
    modules: [VECTOR2, [VECTOR2, import_bcs15.BCS.U8]],
    dependencies: [VECTOR2, import_bcs15.BCS.ADDRESS],
    packageId: import_bcs15.BCS.ADDRESS,
    ticket: ARGUMENT
  }
...
var TransactionBlockDataBuilder = class {
  ...
  static getDigestFromBytes(bytes) {
    ...
    return (0, import_bcs17.toB58)(hash);
  }
  build({
...
var _TransactionBlock = class {
  ...
  static fromKind(serialized) {
    ...
    __privateSet(tx, _blockData, TransactionBlockDataBuilder.fromKindBytes(
      typeof serialized === "string" ? (0, import_bcs19.fromB64)(serialized) : serialized
    ));
    return tx;
  }
  /**
...
validate_fn = function(options) {
  ...
  __privateGet(this, _blockData).inputs.forEach((input, index) => {
    if ((0, import_superstruct20.is)(input.value, PureCallArg)) {
...
var JsonRpcProvider = class {
  ...
  async executeTransactionBlock(input) {
    return await this.client.requestWithType(
      ...
      [
        typeof input.transactionBlock === "string" ? input.transactionBlock : (0, import_bcs20.toB64)(input.transactionBlock),
  ...
  async devInspectTransactionBlock(input) {
    ...
    if (TransactionBlock.is(input.transactionBlock)) {
      ...
      devInspectTxBytes = (0, import_bcs20.toB64)(
      ...
      devInspectTxBytes = (0, import_bcs20.toB64)(input.transactionBlock);
    } else {
  ...
  async getChainIdentifier() {
    ...
    const bytes = (0, import_bcs20.fromB58)(checkpoint.digest);
    return (0, import_bcs20.toHEX)(bytes.slice(0, 4));
  }
...
var SignerWithProvider = class {
  ...
  async signMessage(input) {
    ...
    return {
      messageBytes: (0, import_bcs21.toB64)(input.message),
      signature
    };
  }
  ...
  async signTransactionBlock(input) {
    ...
    return {
      transactionBlockBytes: (0, import_bcs21.toB64)(transactionBlockBytes),
      signature
    };
  }
  /**
  ...
  async dryRunTransactionBlock(input) {
    ...
    if (TransactionBlock.is(input.transactionBlock)) {
      ...
      dryRunTxBytes = (0, import_bcs21.fromB64)(input.transactionBlock);
    } else if (input.transactionBlock instanceof Uint8Array) {
...
async function verifyMessage(message, serializedSignature, scope) {
  ...
  const messageBytes = messageWithIntent(
    scope,
    typeof message === "string" ? (0, import_bcs22.fromB64)(message) : message
  );
  const digest = (0, import_blake2b9.blake2b)(messageBytes, { dkLen: 32 });
