...
var SuiMoveNormalizedModules = record4(
  string7(),
...
var Secp256k1PublicKey = class {
  ...
  toSuiAddress() {
    ...
    tmp.set(this.toBytes(), 1);
    return normalizeSuiAddress(
      bytesToHex3(blake2b3(tmp, { dkLen: 32 })).slice(0, SUI_ADDRESS_LENGTH * 2)
    );
  }
  /**
   * Return the Sui address associated with this Secp256k1 public key
...
var Secp256k1Keypair = class {
  ...
  static fromSecretKey(secretKey, options) {
    ...
    if (!options || !options.skipValidation) {
      ...
      const msgHash = bytesToHex4(blake2b4(signData, { dkLen: 32 }));
...
var Secp256r1Keypair = class {
  ...
  static deriveKeypair(mnemonics, path) {
    ...
    const privateKey = HDKey2.fromMasterSeed(mnemonicToSeed(mnemonics)).derive(
      path
    ).privateKey;
...
function toMultiSigAddress(pks, threshold) {
  ...
  return normalizeSuiAddress(
    bytesToHex6(blake2b6(tmp.slice(0, i), { dkLen: 32 }))
  );
}
